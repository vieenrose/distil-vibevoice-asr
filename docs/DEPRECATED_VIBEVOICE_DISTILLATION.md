...
*(Original plan, kept for the record. Superseded first by a fine-tuned MOSS-TD lineage, then by the purification-first rebuild described in the [root README](../README.md).)*
